    ...
    <SessionProvider>
      ...
      >
        <div className="flex min-h-screen bg-gray-900">
          ...
          <div className="fixed top-0 left-0 z-40 h-screen bg-gray-800">
          ...
          <div className="flex flex-col flex-1 md:ml-64 min-h-screen">
            ...
            {/* Contenu scrollable */}
            <div className="flex-1 mt-16"> {/* mt-16 pour compenser le header fixe */}
              <ClientWrapper 
                userId={session.user.id}
                className="w-full min-h-full p-2 md:p-4 bg-gray-900"
              >
                {children}
              </ClientWrapper>
            </div>
