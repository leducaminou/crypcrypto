...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-gray-900 bg-opacity-95 backdrop-blur-md py-2 border-b border-gray-800' : 'bg-gray-900 bg-opacity-80 backdrop-blur-md py-3'}`}>
