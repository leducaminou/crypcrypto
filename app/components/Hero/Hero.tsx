          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 my-16">
            <div className="col-span-7">
              <h1 className="text-4xl lg:text-5xl font-bold mb-5 text-white md:4px md:text-start text-center">
                Générez des Revenus Passifs avec la Puissance de l'IA
              </h1>
              <p className="text-white md:text-lg font-normal mb-10 md:text-start text-center">
                Notre algorithme d'Intelligence Artificielle de pointe 
                analyse <br /> les marchés crypto 24h/24 et 7j/7 pour exécuter des
                trades <br />à haut rendement. Investissez, et laissez la
                technologie <br /> travailler pour vous.
              </p>
              <div className="flex flex-col align-middle justify-center md:flex-row gap-4 md:gap-1">
                <button
                  className="text-xl font-semibold text-white py-4 px-6 lg:px-12 bg-gradient-to-r from-primary to-secondary 
                hover:from-secondary hover:to-primary rounded-xl mr-6"
                >
